...
import uk.gov.hmrc.selfassessmentapi.resources.models.selfemployment.{SelfEmployment, SelfEmploymentAnnualSummary, SelfEmploymentPeriod}
...
trait SelfEmploymentsService extends PeriodService[SourceId, SelfEmploymentPeriod, domain.SelfEmployment] with AnnualSummaryService[SelfEmploymentAnnualSummary, domain.SelfEmployment] {
